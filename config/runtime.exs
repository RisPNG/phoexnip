...
#
#     PHX_SERVER=true bin/phoexnip start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :phoexnip, PhoexnipWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  #
  config :phoexnip, PhoexnipWeb.Endpoint, force_ssl: [hsts: true]
  swagger_host = System.get_env("SWAGGER_HOST") || host
  config :phoexnip, :swagger_host, swagger_host

  from_name = System.get_env("MAIL_FROM_NAME") || "Phoexnip"
  from_email = System.get_env("MAIL_FROM_EMAIL") || "noreply@example.com"
  config :phoexnip, :mailer_from, {from_name, from_email}
  ...
  #
  config :phoexnip, Phoexnip.Mailer,
    adapter: Swoosh.Adapters.SMTP,
    relay: "smtp.office365.com",
    username: System.get_env("OFFICE365_USERNAME"),
    password: System.get_env("OFFICE365_PASSWORD"),
    port: 587,
    ssl: false,
    tls: :always,
    auth: :always,
