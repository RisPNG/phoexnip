(() => {
  ...
  var require_flatpickr_min = __commonJS({
    "js/flatpickr.min.js"(exports, module) {
      !function(e, n) {
        ...
        function n() {
          ...
          for (n2 = 0; n2 < t2; n2++)
            for (var o3 = arguments[n2], r2 = 0, l2 = o3.length; r2 < l2; r2++, i2++)
              a2[i2] = o3[r2];
          return a2;
        }
        var t = [
          ...
          getWeek: function(e2) {
            ...
            return 1 + Math.round(
              ((n2.getTime() - t2.getTime()) / 864e5 - 3 + (t2.getDay() + 6) % 7) / 7
            );
          },
          hourIncrement: 1,
        ...
        function m(e2, n2) {
          var t2 = d("div", "numInputWrapper"), a2 = d("input", "numInput " + e2), i2 = d("span", "arrowUp"), o3 = d("span", "arrowDown");
          if (-1 === navigator.userAgent.indexOf("MSIE 9.0") ? a2.type = "number" : (a2.type = "text", a2.pattern = "\\d*"), void 0 !== n2)
            for (var r2 in n2)
              a2.setAttribute(r2, n2[r2]);
          return t2.appendChild(a2), t2.appendChild(i2), t2.appendChild(o3), t2;
        }
        function g(e2) {
          try {
        ...
        var p = function() {
          ...
          K: function(e2, n2, t2) {
            e2.setHours(
              e2.getHours() % 12 + 12 * r(new RegExp(t2.amPM[1], "i").test(n2))
            );
          },
          M: function(e2, n2, t2) {
          ...
          G: function(e2, n2, t2) {
            return o2(w.h(e2, n2, t2));
          },
          H: function(e2) {
            return o2(e2.getHours());
          },
          J: function(e2, n2) {
          ...
          Y: function(e2) {
            return o2(e2.getFullYear(), 4);
          },
          d: function(e2) {
            return o2(e2.getDate());
          },
          h: function(e2) {
            return e2.getHours() % 12 ? e2.getHours() % 12 : 12;
          },
          i: function(e2) {
            return o2(e2.getMinutes());
          },
          j: function(e2) {
            return e2.getDate();
          },
          ...
          var n2 = e2.config, t2 = void 0 === n2 ? a : n2, o3 = e2.l10n, r2 = void 0 === o3 ? i : o3, l2 = e2.isMobile, c2 = void 0 !== l2 && l2;
          return function(e3, n3, a2) {
            var i2 = a2 || r2;
            return void 0 === t2.formatDate || c2 ? n3.split("").map(function(n4, a3, o4) {
              return w[n4] && "\\" !== o4[a3 - 1] ? w[n4](e3, i2, t2) : "\\" !== n4 ? n4 : "";
            }).join("") : t2.formatDate(e3, n3, i2);
          };
        }, C = function(e2) {
          var n2 = e2.config, t2 = void 0 === n2 ? a : n2, o3 = e2.l10n, r2 = void 0 === o3 ? i : o3;
          return function(e3, n3, i2, o4) {
            if (0 === e3 || e3) {
              var l2, c2 = o4 || r2, s2 = e3;
                ...
                if ("today" === u2)
                  ...
                  for (var f2 = void 0, m2 = [], g2 = 0, p2 = 0, h2 = ""; g2 < d2.length; g2++) {
                    ...
                    if (D[w2] && !C2) {
                      ...
                      M2 && (f2 = true) && m2["Y" !== w2 ? "push" : "unshift"]({
                        fn: v[w2],
                        val: M2[++p2]
                      });
                    } else
        ...
        function E(e2) {
          ...
          if (void 0 !== e2.minDate) {
            var i2 = e2.minDate.getHours(), o3 = e2.minDate.getMinutes(), r2 = e2.minDate.getSeconds();
            n2 < i2 && (n2 = i2), n2 === i2 && t2 < o3 && (t2 = o3), n2 === i2 && t2 === o3 && a2 < r2 && (a2 = e2.minDate.getSeconds());
          }
        ...
        function k(p2, v2) {
          ...
          function _(e2) {
            ...
            void 0 !== e2 && "blur" !== e2.type && function(e3) {
              ...
              if (void 0 !== a3.value && 2 === a3.value.length) {
                ...
                u2 < i2 ? (u2 = l2 + u2 + r(!f2) + (r(f2) && r(!w2.amPM)), m2 && L(void 0, -1, w2.hourElement)) : u2 > l2 && (u2 = a3 === w2.hourElement ? u2 - l2 - r(!w2.amPM) : i2, m2 && L(void 0, 1, w2.hourElement)), w2.amPM && f2 && (1 === c2 ? u2 + s2 === 23 : Math.abs(u2 - s2) > c2) && (w2.amPM.textContent = w2.l10n.amPM[r(w2.amPM.textContent === w2.l10n.amPM[0])]), a3.value = o2(u2);
              }
            }(e2);
          ...
          function O() {
            if (void 0 !== w2.hourElement && void 0 !== w2.minuteElement) {
              ...
              var o3 = void 0 !== w2.config.minTime || w2.config.minDate && w2.minDateHasTime && w2.latestSelectedDateObj && 0 === M(w2.latestSelectedDateObj, w2.config.minDate, true), l2 = void 0 !== w2.config.maxTime || w2.config.maxDate && w2.maxDateHasTime && w2.latestSelectedDateObj && 0 === M(w2.latestSelectedDateObj, w2.config.maxDate, true);
              if (void 0 !== w2.config.maxTime && void 0 !== w2.config.minTime && w2.config.minTime > w2.config.maxTime) {
                var c2 = y(
                  w2.config.minTime.getHours(),
                  w2.config.minTime.getMinutes(),
                  w2.config.minTime.getSeconds()
                ), s2 = y(
                  w2.config.maxTime.getHours(),
                  w2.config.maxTime.getMinutes(),
                  w2.config.maxTime.getSeconds()
                ), d2 = y(t2, a2, i2);
                if (d2 > s2 && d2 < c2) {
                  var u2 = function(e3) {
          ...
          function A(e2, n2, t2) {
            void 0 !== w2.latestSelectedDateObj && w2.latestSelectedDateObj.setHours(e2 % 24, n2, t2 || 0, 0), w2.hourElement && w2.minuteElement && !w2.isMobile && (w2.hourElement.value = o2(
              w2.config.time_24hr ? e2 : (12 + e2) % 12 + 12 * r(e2 % 12 == 0)
            ), w2.minuteElement.value = o2(n2), void 0 !== w2.amPM && (w2.amPM.textContent = w2.l10n.amPM[r(e2 >= 12)]), void 0 !== w2.secondElement && (w2.secondElement.value = o2(t2)));
          }
          function N(e2) {
          ...
          function P(e2, n2, t2, a2) {
            ...
            }) : (e2.addEventListener(n2, t2, a2), void w2._handlers.push({
              remove: function() {
          ...
          function L(e2, n2, t2) {
            var a2 = e2 && g(e2), i2 = t2 || a2 && a2.parentNode && a2.parentNode.firstChild, o3 = we("increment");
            o3.delta = n2, i2 && i2.dispatchEvent(o3);
          }
          function R(e2, n2, t2, a2) {
            var i2 = ne(n2, true), o3 = d("span", e2, n2.getDate().toString());
            return o3.dateObj = n2, o3.$i = a2, o3.setAttribute("aria-label", w2.formatDate(n2, w2.config.ariaDateFormat)), -1 === e2.indexOf("hidden") && 0 === M(n2, w2.now) && (w2.todayDateElem = o3, o3.classList.add("today"), o3.setAttribute("aria-current", "date")), i2 ? (o3.tabIndex = -1, be(n2) && (o3.classList.add("selected"), w2.selectedDateElem = o3, "range" === w2.config.mode && (s(
              o3,
              "startRange",
              w2.selectedDates[0] && 0 === M(n2, w2.selectedDates[0], true)
            ), s(
              o3,
              "endRange",
              w2.selectedDates[1] && 0 === M(n2, w2.selectedDates[1], true)
            ), "nextMonthDay" === e2 && o3.classList.add("inRange")))) : o3.classList.add("flatpickr-disabled"), "range" === w2.config.mode && function(e3) {
              return !("range" !== w2.config.mode || w2.selectedDates.length < 2) && M(e3, w2.selectedDates[0]) >= 0 && M(e3, w2.selectedDates[1]) <= 0;
            }(n2) && !be(n2) && o3.classList.add("inRange"), w2.weekNumbers && 1 === w2.config.showMonths && "prevMonthDay" !== e2 && a2 % 7 == 6 && w2.weekNumbers.insertAdjacentHTML(
              "beforeend",
              "<span class='flatpickr-day'>" + w2.config.getWeek(n2) + "</span>"
            ), De("onDayCreate", o3), o3;
          }
          function W(e2) {
          ...
          function B(e2) {
            for (var n2 = e2 > 0 ? 0 : w2.config.showMonths - 1, t2 = e2 > 0 ? w2.config.showMonths : -1, a2 = n2; a2 != t2; a2 += e2)
              for (var i2 = w2.daysContainer.children[a2], o3 = e2 > 0 ? 0 : i2.children.length - 1, r2 = e2 > 0 ? i2.children.length : -1, l2 = o3; l2 != r2; l2 += e2) {
          ...
          function J(e2, n2) {
            ...
            void 0 === i2 ? w2._input.focus() : a2 ? function(e3, n3) {
              for (var t3 = -1 === e3.className.indexOf("Month") ? e3.dateObj.getMonth() : w2.currentMonth, a3 = n3 > 0 ? w2.config.showMonths : -1, i3 = n3 > 0 ? 1 : -1, o3 = t3 - w2.currentMonth; o3 != a3; o3 += i3)
                for (var r2 = w2.daysContainer.children[o3], l2 = t3 - w2.currentMonth === o3 ? e3.$i + n3 : n3 < 0 ? r2.children.length - 1 : 0, c2 = r2.children.length, s2 = l2; s2 >= 0 && s2 < c2 && s2 != (n3 > 0 ? c2 : -1); s2 += i3) {
          ...
          function K(e2, n2) {
            for (var t2 = (new Date(e2, n2, 1).getDay() - w2.l10n.firstDayOfWeek + 7) % 7, a2 = w2.utils.getDaysInMonth((n2 - 1 + 12) % 12, e2), i2 = w2.utils.getDaysInMonth(n2, e2), o3 = window.document.createDocumentFragment(), r2 = w2.config.showMonths > 1, l2 = r2 ? "prevMonthDay hidden" : "prevMonthDay", c2 = r2 ? "nextMonthDay hidden" : "nextMonthDay", s2 = a2 + 1 - t2, u2 = 0; s2 <= a2; s2++, u2++)
              o3.appendChild(R("flatpickr-day " + l2, new Date(e2, n2 - 1, s2), 0, u2));
            for (s2 = 1; s2 <= i2; s2++, u2++)
              o3.appendChild(R("flatpickr-day", new Date(e2, n2, s2), 0, u2));
            for (var f2 = i2 + 1; f2 <= 42 - t2 && (1 === w2.config.showMonths || u2 % 7 != 0); f2++, u2++)
              o3.appendChild(R("flatpickr-day " + c2, new Date(e2, n2 + 1, f2 % i2), 0, u2));
            var m2 = d("div", "dayContainer");
            return m2.appendChild(o3), m2;
          }
          function U() {
          ...
          function $() {
            ...
            w2.config.showMonths > 1 || "static" === w2.config.monthSelectorType ? e2 = d("span", "cur-month") : (w2.monthsDropdownContainer = d(
              "select",
              "flatpickr-monthDropdown-months"
            ), w2.monthsDropdownContainer.setAttribute(
              "aria-label",
              w2.l10n.monthAriaLabel
            ), P(w2.monthsDropdownContainer, "change", function(e3) {
            ...
            var o3 = d("div", "flatpickr-current-month");
            return o3.appendChild(e2), o3.appendChild(a2), t2.appendChild(o3), n2.appendChild(t2), { container: n2, yearElement: i2, monthElement: e2 };
          }
          function V() {
          ...
          function X(e2) {
            if (w2.isOpen && !w2.config.inline) {
              ...
              a2 && i2 && (w2.config.allowInput && w2.setDate(
                w2._input.value,
                false,
                w2.config.altInput ? w2.config.altFormat : w2.config.dateFormat
              ), void 0 !== w2.timeContainer && void 0 !== w2.minuteElement && void 0 !== w2.hourElement && "" !== w2.input.value && void 0 !== w2.input.value && _(), w2.close(), w2.config && "range" === w2.config.mode && 1 === w2.selectedDates.length && w2.clear(false));
            }
          }
          function ee(e2) {
            if (!(!e2 || w2.config.minDate && e2 < w2.config.minDate.getFullYear() || w2.config.maxDate && e2 > w2.config.maxDate.getFullYear())) {
              ...
              w2.currentYear = n2 || w2.currentYear, w2.config.maxDate && w2.currentYear === w2.config.maxDate.getFullYear() ? w2.currentMonth = Math.min(
                w2.config.maxDate.getMonth(),
                w2.currentMonth
              ) : w2.config.minDate && w2.currentYear === w2.config.minDate.getFullYear() && (w2.currentMonth = Math.max(
                w2.config.minDate.getMonth(),
                w2.currentMonth
              )), t2 && (w2.redraw(), De("onYearChange"), q());
            }
          }
          function ne(e2, n2) {
            var t2;
            ...
            if (void 0 === a2)
              return false;
            for (var i2 = !!w2.config.enable, o3 = null !== (t2 = w2.config.enable) && void 0 !== t2 ? t2 : w2.config.disable, r2 = 0, l2 = void 0; r2 < o3.length; r2++) {
              if ("function" == typeof (l2 = o3[r2]) && l2(a2))
                return i2;
          ...
          function ae(e2) {
            ...
            !n2 || !t2 || e2.relatedTarget && Q(e2.relatedTarget) || w2.setDate(
              w2._input.value,
              true,
              e2.target === w2.altInput ? w2.config.altFormat : w2.config.dateFormat
            );
          }
          function ie(e2) {
            var n2 = g(e2), t2 = w2.config.wrap ? p2.contains(n2) : n2 === w2._input, a2 = w2.config.allowInput, i2 = w2.isOpen && (!a2 || !t2), o3 = w2.config.inline && t2 && !a2;
            if (13 === e2.keyCode && t2) {
              if (a2)
                return w2.setDate(
                  w2._input.value,
                  true,
                  n2 === w2.altInput ? w2.config.altFormat : w2.config.dateFormat
                ), w2.close(), n2.blur();
              w2.open();
            } else if (Q(n2) || i2 || o3) {
          ...
          function oe(e2, n2) {
            if (void 0 === n2 && (n2 = "flatpickr-day"), 1 === w2.selectedDates.length && (!e2 || e2.classList.contains(n2) && !e2.classList.contains("flatpickr-disabled"))) {
              for (var t2 = e2 ? e2.dateObj.getTime() : w2.days.firstElementChild.dateObj.getTime(), a2 = w2.parseDate(w2.selectedDates[0], void 0, true).getTime(), i2 = Math.min(t2, w2.selectedDates[0].getTime()), o3 = Math.max(t2, w2.selectedDates[0].getTime()), r2 = false, l2 = 0, c2 = 0, s2 = i2; s2 < o3; s2 += x)
                ne(new Date(s2), true) || (r2 = r2 || s2 > i2 && s2 < o3, s2 < a2 && (!l2 || s2 > l2) ? l2 = s2 : s2 > a2 && (!c2 || s2 < c2) && (c2 = s2));
              Array.from(
                w2.rContainer.querySelectorAll(
                  "*:nth-child(-n+" + w2.config.showMonths + ") > ." + n2
                )
              ).forEach(function(n3) {
                var i3, o4, s3, d2 = n3.dateObj.getTime(), u2 = l2 > 0 && d2 < l2 || c2 > 0 && d2 > c2;
                if (u2)
                  return n3.classList.add("notAllowed"), void ["inRange", "startRange", "endRange"].forEach(function(e3) {
                    n3.classList.remove(e3);
                  });
                r2 && !u2 || (["startRange", "inRange", "endRange", "notAllowed"].forEach(
                  function(e3) {
                    n3.classList.remove(e3);
                  }
                ), void 0 !== e2 && (e2.classList.add(
                  t2 <= w2.selectedDates[0].getTime() ? "startRange" : "endRange"
                ), a2 < t2 && d2 === a2 ? n3.classList.add("startRange") : a2 > t2 && d2 === a2 && n3.classList.add("endRange"), d2 >= l2 && (0 === c2 || d2 <= c2) && (o4 = a2, s3 = t2, (i3 = d2) > Math.min(o4, s3) && i3 < Math.max(o4, s3)) && n3.classList.add("inRange")));
              });
            }
          }
          function re() {
          ...
          function le(e2) {
            return function(n2) {
              var t2 = w2.config["_" + e2 + "Date"] = w2.parseDate(
                n2,
                w2.config.dateFormat
              ), a2 = w2.config["_" + ("min" === e2 ? "max" : "min") + "Date"];
          ...
          function se() {
            "object" != typeof w2.config.locale && void 0 === I.l10ns[w2.config.locale] && w2.config.errorHandler(
              new Error("flatpickr: invalid locale " + w2.config.locale)
            ), w2.l10n = e(
              e({}, I.l10ns.default),
              "object" == typeof w2.config.locale ? w2.config.locale : "default" !== w2.config.locale ? I.l10ns[w2.config.locale] : void 0
            ), D.D = "(" + w2.l10n.weekdays.shorthand.join("|") + ")", D.l = "(" + w2.l10n.weekdays.longhand.join("|") + ")", D.M = "(" + w2.l10n.months.shorthand.join("|") + ")", D.F = "(" + w2.l10n.months.longhand.join("|") + ")", D.K = "(" + w2.l10n.amPM[0] + "|" + w2.l10n.amPM[1] + "|" + w2.l10n.amPM[0].toLowerCase() + "|" + w2.l10n.amPM[1].toLowerCase() + ")", void 0 === e(e({}, v2), JSON.parse(JSON.stringify(p2.dataset || {}))).time_24hr && void 0 === I.defaultConfig.time_24hr && (w2.config.time_24hr = w2.l10n.time_24hr), w2.formatDate = b(w2), w2.parseDate = C({ config: w2.config, l10n: w2.l10n });
          }
          function de(e2) {
            if ("function" != typeof w2.config.position) {
              if (void 0 !== w2.calendarContainer) {
                De("onPreCalendarPosition");
                var n2 = e2 || w2._positionElement, t2 = Array.prototype.reduce.call(
                  w2.calendarContainer.children,
                  function(e3, n3) {
                    return e3 + n3.offsetHeight;
                  },
                  0
                ), a2 = w2.calendarContainer.offsetWidth, i2 = w2.config.position.split(" "), o3 = i2[0], r2 = i2.length > 1 ? i2[1] : null, l2 = n2.getBoundingClientRect(), c2 = window.innerHeight - l2.bottom, d2 = "above" === o3 || "below" !== o3 && c2 < t2 && l2.top > t2, u2 = window.pageYOffset + l2.top + (d2 ? -t2 - 2 : n2.offsetHeight + 2);
                  ...
                  if (s(w2.calendarContainer, "rightMost", h2), !w2.config.static)
                    if (w2.calendarContainer.style.top = u2 + "px", h2)
                      if (v3) {
                        ...
                        s(w2.calendarContainer, "rightMost", false), s(w2.calendarContainer, "centerMost", true), D2.insertRule(
                          ".flatpickr-calendar.centerMost:before,.flatpickr-calendar.centerMost:after" + y2,
                          M2
                        ), w2.calendarContainer.style.left = C2 + "px", w2.calendarContainer.style.right = "auto";
                      } else
          ...
          function me(e2) {
            ...
            if (void 0 !== n2) {
              ...
              if (w2.selectedDateElem = t2, "single" === w2.config.mode)
                ...
                var o3 = be(a2);
                o3 ? w2.selectedDates.splice(parseInt(o3), 1) : w2.selectedDates.push(a2);
              } else
          ...
          w2.parseDate = C({ config: w2.config, l10n: w2.l10n }), w2._handlers = [], w2.pluginElements = [], w2.loadedPlugins = [], w2._bind = P, w2._setHoursFromDate = F, w2._positionCalendar = de, w2.changeMonth = Z, w2.changeYear = ee, w2.clear = function(e2, n2) {
            ...
            if (true === w2.config.enableTime) {
              var t2 = E(w2.config), a2 = t2.hours, i2 = t2.minutes, o3 = t2.seconds;
              A(a2, i2, o3);
            }
          ...
          function pe(e2, n2) {
            ...
            if (e2 instanceof Array)
              ...
              w2.config.errorHandler(
                new Error("Invalid date supplied: " + JSON.stringify(e2))
              );
          ...
          function he(e2) {
            return e2.slice().map(function(e3) {
              return "string" == typeof e3 || "number" == typeof e3 || e3 instanceof Date ? w2.parseDate(e3, void 0, true) : e3 && "object" == typeof e3 && e3.from && e3.to ? {
                from: w2.parseDate(e3.from, void 0),
                to: w2.parseDate(e3.to, void 0)
              } : e3;
            }).filter(function(e3) {
              return e3;
            });
          ...
          function Me(e2) {
            ...
            return w2.selectedDates.map(function(e3) {
              ...
              "range" !== w2.config.mode ? w2.config.conjunction : w2.l10n.rangeSeparator
            );
          }
          function ye(e2) {
          ...
          return function() {
            w2.element = w2.input = p2, w2.isOpen = false, function() {
              var n3 = [
                ...
                "enableSeconds",
                "disableMobile"
              ], i2 = e(e({}, JSON.parse(JSON.stringify(p2.dataset || {}))), v2), o3 = {};
              w2.config.parseDate = i2.parseDate, w2.config.formatDate = i2.formatDate, Object.defineProperty(w2.config, "enable", {
                get: function() {
              ...
              }), Object.defineProperty(w2.config, "disable", {
                get: function() {
              ...
              if (!i2.dateFormat && (i2.enableTime || r2)) {
                ...
                o3.dateFormat = i2.noCalendar || r2 ? "H:i" + (i2.enableSeconds ? ":S" : "") : l2 + " H:i" + (i2.enableSeconds ? ":S" : "");
              }
              if (i2.altInput && (i2.enableTime || r2) && !i2.altFormat) {
                var s2 = I.defaultConfig.altFormat || a.altFormat;
                o3.altFormat = i2.noCalendar || r2 ? "h:i" + (i2.enableSeconds ? ":S K" : " K") : s2 + " h:i" + (i2.enableSeconds ? ":S" : "") + " K";
              }
              Object.defineProperty(w2.config, "minDate", {
                get: function() {
                  return w2.config._minDate;
                },
                set: le("min")
              }), Object.defineProperty(w2.config, "maxDate", {
                get: function() {
              ...
              var d2 = function(e2) {
                return function(n4) {
                  w2.config["min" === e2 ? "_minTime" : "_maxTime"] = w2.parseDate(
                    n4,
                    "H:i:S"
                  );
                };
              };
              Object.defineProperty(w2.config, "minTime", {
                get: function() {
                  return w2.config._minTime;
                },
                set: d2("min")
              }), Object.defineProperty(w2.config, "maxTime", {
                get: function() {
                  return w2.config._maxTime;
                },
                set: d2("max")
              }), "time" === i2.mode && (w2.config.noCalendar = true, w2.config.enableTime = true);
              Object.assign(w2.config, o3, i2);
              ...
              }), w2.isMobile = !w2.config.disableMobile && !w2.config.inline && "single" === w2.config.mode && !w2.config.disable.length && !w2.config.enable && !w2.config.weekNumbers && /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(
                navigator.userAgent
              );
              ...
              if (w2.calendarContainer = d("div", "flatpickr-calendar"), w2.calendarContainer.tabIndex = -1, !w2.config.noCalendar) {
                if (e2.appendChild(
                  ...
                  }), Object.defineProperty(w2, "_hideNextMonthArrow", {
                    get: function() {
                  ...
                  }), w2.currentYearElement = w2.yearElements[0], Ce(), w2.monthNav)
                ), w2.innerContainer = d("div", "flatpickr-innerContainer"), w2.config.weekNumbers) {
                  var n3 = function() {
                    w2.calendarContainer.classList.add("hasWeeks");
                    var e3 = d("div", "flatpickr-weekwrapper");
                    e3.appendChild(
                      d("span", "flatpickr-weekday", w2.l10n.weekAbbreviation)
                    );
              ...
              w2.config.enableTime && e2.appendChild(
                function() {
                  ...
                  var n4 = d("span", "flatpickr-time-separator", ":"), t3 = m("flatpickr-hour", {
                    "aria-label": w2.l10n.hourAriaLabel
                  });
                  w2.hourElement = t3.getElementsByTagName("input")[0];
                  var a3 = m("flatpickr-minute", {
                    "aria-label": w2.l10n.minuteAriaLabel
                  });
                  w2.minuteElement = a3.getElementsByTagName("input")[0], w2.hourElement.tabIndex = w2.minuteElement.tabIndex = -1, w2.hourElement.value = o2(
                    w2.latestSelectedDateObj ? w2.latestSelectedDateObj.getHours() : w2.config.time_24hr ? e3.hours : function(e4) {
                      switch (e4 % 24) {
                        case 0:
                        case 12:
                          return 12;
                  ...
                  ), w2.minuteElement.value = o2(
                    w2.latestSelectedDateObj ? w2.latestSelectedDateObj.getMinutes() : e3.minutes
                  ), w2.hourElement.setAttribute(
                    "step",
                    w2.config.hourIncrement.toString()
                  ), w2.minuteElement.setAttribute(
                    "step",
                    w2.config.minuteIncrement.toString()
                  ), w2.hourElement.setAttribute(
                    "min",
                    w2.config.time_24hr ? "0" : "1"
                  ), w2.hourElement.setAttribute(
                    "max",
                    w2.config.time_24hr ? "23" : "12"
                  ), w2.hourElement.setAttribute("maxlength", "2"), w2.minuteElement.setAttribute("min", "0"), w2.minuteElement.setAttribute("max", "59"), w2.minuteElement.setAttribute("maxlength", "2"), w2.timeContainer.appendChild(t3), w2.timeContainer.appendChild(n4), w2.timeContainer.appendChild(a3), w2.config.time_24hr && w2.timeContainer.classList.add("time24hr");
                  if (w2.config.enableSeconds) {
                    w2.timeContainer.classList.add("hasSeconds");
                    var i3 = m("flatpickr-second");
                    w2.secondElement = i3.getElementsByTagName("input")[0], w2.secondElement.value = o2(
                      w2.latestSelectedDateObj ? w2.latestSelectedDateObj.getSeconds() : e3.seconds
                    ), w2.secondElement.setAttribute(
                      "step",
                      w2.minuteElement.getAttribute("step")
                    ), w2.secondElement.setAttribute("min", "0"), w2.secondElement.setAttribute("max", "59"), w2.secondElement.setAttribute("maxlength", "2"), w2.timeContainer.appendChild(
                      d("span", "flatpickr-time-separator", ":")
                    ), w2.timeContainer.appendChild(i3);
                  }
                  w2.config.time_24hr || (w2.amPM = d(
                    "span",
                    "flatpickr-am-pm",
                    w2.l10n.amPM[r(
                      (w2.latestSelectedDateObj ? w2.hourElement.value : w2.config.defaultHour) > 11
                    )]
                  ), w2.amPM.title = w2.l10n.toggleTitle, w2.amPM.tabIndex = -1, w2.timeContainer.appendChild(w2.amPM));
              ...
              if ((w2.config.inline || w2.config.static) && (w2.calendarContainer.classList.add(
                w2.config.inline ? "inline" : "static"
              ), w2.config.inline && (!i2 && w2.element.parentNode ? w2.element.parentNode.insertBefore(
                w2.calendarContainer,
                w2._input.nextSibling
              ) : void 0 !== w2.config.appendTo && w2.config.appendTo.appendChild(w2.calendarContainer)), w2.config.static)) {
              ...
              w2.config.wrap && ["open", "close", "toggle", "clear"].forEach(function(e3) {
                Array.prototype.forEach.call(
                  w2.element.querySelectorAll("[data-" + e3 + "]"),
                  function(n4) {
              ...
              if (w2.isMobile)
                return void function() {
                  ...
                  try {
                    w2.input.parentNode && w2.input.parentNode.insertBefore(
                      w2.mobileInput,
                      w2.input.nextSibling
                    );
                  } catch (e4) {
        ...
        function T(e2, n2) {
          for (var t2 = Array.prototype.slice.call(e2).filter(function(e3) {
            ...
            var o3 = t2[i2];
            try {
              if (null !== o3.getAttribute("data-fp-omit"))
                continue;
              void 0 !== o3._flatpickr && (o3._flatpickr.destroy(), o3._flatpickr = void 0), o3._flatpickr = k(o3, n2 || {}), a2.push(o3._flatpickr);
            } catch (e3) {
              console.error(e3);
            }
          }
        ...
        return I.defaultConfig = {}, I.l10ns = { en: e({}, i), default: e({}, i) }, I.localize = function(n2) {
          ...
          return new Date(
            this.getFullYear(),
            this.getMonth(),
            this.getDate() + ("string" == typeof e2 ? parseInt(e2, 10) : e2)
          );
...
`
  ...
  var live_select_min_default = { LiveSelect: { textInput() {
    ...
    const t = this.el.querySelector("button.ls-clear-button");
    t && (this.textInput().parentElement.style.position = "relative", this.textInput().parentElement.style.display = "flex", this.textInput().parentElement.style.alignItems = "center", t.style.minHeight = "20px", t.style.minWidth = "20px", t.style.position = "absolute", t.style.right = "5px", t.style.display = "block"), this.el.querySelectorAll("button.ls-clear-tag-button").forEach((e) => {
      e.style.minHeight = "20px", e.style.minWidth = "20px";
    });
  }, pushEventToParent(t, e) {
    const i = this.el.dataset.phxTarget;
    i ? this.pushEventTo(i, t, e) : this.pushEvent(t, e);
  }, attachDomEventHandlers() {
    this.textInput().onkeydown = (e) => {
      e.code === "Enter" && e.preventDefault();
      const s = Array.from(this.el.querySelectorAll("div[data-idx]")).sort((n, l) => n.getBoundingClientRect().top - l.getBoundingClientRect().top).map((n) => parseInt(n.dataset.idx));
      this.pushEventTo(this.el, "keydown", { key: e.code, visual_order: s });
    }, this.changeEvents = o((e, i, s) => {
      this.pushEventTo(this.el, "change", { text: s }), this.pushEventToParent("live_select_change", { id: this.el.id, field: i, text: s });
    }, this.debounceMsec()), this.textInput().oninput = (e) => {
      const i = e.target.value.trim(), s = this.el.dataset.field;
      i.length >= this.updateMinLen() ? this.changeEvents(this.el.id, s, i) : this.pushEventTo(this.el, "options_clear", {});
    };
    const t = this.el.querySelector("ul");
    t && (t.onmousedown = (e) => {
      const i = e.target.closest("div[data-idx]");
      i && (this.pushEventTo(this.el, "option_click", { idx: i.dataset.idx }), e.preventDefault());
    }), this.el.querySelectorAll("button[data-idx]").forEach((e) => {
      e.onclick = (i) => {
        this.pushEventTo(this.el, "option_remove", { idx: e.dataset.idx });
      };
    });
  }, setInputValue(t) {
    this.textInput().value = t;
  }, inputEvent(t, e) {
    const i = e === "single" ? "input.single-mode" : t.length === 0 ? "input[data-live-select-empty]" : "input[type=hidden]";
    this.el.querySelector(i).dispatchEvent(new Event("input", { bubbles: true }));
  }, mounted() {
    this.maybeStyleClearButtons(), this.handleEvent("select", ({ id: t, selection: e, mode: i, current_text: s, input_event: n, parent_event: l }) => {
      this.el.id === t && (this.selection = e, this._skipNextScroll = true, s != null && this.setInputValue(s), n && this.inputEvent(e, i), l && this.pushEventToParent(l, { id: t }));
    }), this.handleEvent("scroll_to_option", ({ id: t, idx: e }) => {
      if (this.el.id === t) {
        if (this._skipNextScroll) {
          this._skipNextScroll = false;
          return;
        }
        const i = this.el.querySelector(`div[data-idx="${e}"]`);
        i && i.scrollIntoView({ block: "nearest", behavior: "instant", container: "nearest" });
      }
    }), this.attachDomEventHandlers(), this.textInput().addEventListener("blur", () => {
      clearTimeout(this._blurTimeout), this._blurTimeout = setTimeout(() => {
        document.activeElement !== this.textInput() && this.pushEventTo(this.el, "self_blur", {});
      }, 100);
    });
  }, beforeUpdate() {
    const t = this.el.querySelector("ul");
    this._dropdownScrollTop = t ? t.scrollTop : null;
  }, updated() {
    if (this._dropdownScrollTop != null) {
      const t = this.el.querySelector("ul");
      t && (t.scrollTop = this._dropdownScrollTop), this._dropdownScrollTop = null;
    }
    this.maybeStyleClearButtons(), this.attachDomEventHandlers();
  }, reconnected() {
    this.selection && this.selection.length > 0 && this.pushEventTo(this.el, "selection_recovery", this.selection);
  } } };

  // js/app.js
  var import_topbar = __toESM(require_topbar());
  var import_flatpickr_min = __toESM(require_flatpickr_min());
  var Hooks2 = {};
  Hooks2.DatePicker = {
    mounted() {
      const parent = this.el.parentElement;
      if (parent.classList.contains("ban-future") && parent.classList.contains("ban-past")) {
        console.log("you are an idiot. - Cees");
        setupDatePicker(this.el, false, false);
      } else if (parent.classList.contains("ban-future") && !parent.classList.contains("ban-past")) {
  ...
  function setupDatePicker(element, can_be_in_the_future = true, can_be_in_the_past = true, altFormat = "d/m/Y", dateFormat = "Y-m-d", show_time = false) {
    let minDate = null;
    let maxDate = null;
    ...
    flatpickr(element, {
      ...
      dateFormat,
      minDate,
      // Apply minDate dynamically
      maxDate,
      // Apply maxDate dynamically
      allowInput: true,
      onChange: () => {
      ...
      onReady: function(selectedDates, dateStr, instance) {
        ...
        if (calendarContainer) {
          ...
          todayButton.addEventListener("click", () => {
            instance.setDate(/* @__PURE__ */ new Date(), true);
            instance.close();
          });
  ...
  function dateBetween(element, date_type, truncate_time = true) {
    ...
    if (date_type == "start") {
      ...
      end_date = new Date(
        element.parentElement.parentElement.querySelector(".end-date").querySelector("input").value
      );
    }
    if (date_type == "end") {
      start_date = new Date(
        element.parentElement.parentElement.querySelector(".start-date").querySelector("input").value
      );
    ...
    const diffInDays = (diffInMilliseconds / (1e3 * 60 * 60 * 24)).toFixed(1);
    element.parentElement.parentElement.querySelector(".date-between-result").querySelector("input").value = diffInDays;
  }
  ...
  Hooks2.AutoResize = {
    mounted() {
      if (this.el.dataset.resizetextarea == void 0 || this.el.dataset.resizetextarea === "true" == true) {
        this.resizeTextarea();
        this.el.addEventListener("input", () => this.resizeTextarea());
      }
      if (this.el.dataset.maxRows != void 0) {
        this.limitMaxRows();
      }
    },
    updated() {
  ...
  Hooks2.LiveSelectAbsolute = {
    mounted() {
      var _a, _b, _c;
      if (!this.el.id) {
        this.el.id = `lswrapper-${(_c = (_b = (_a = globalThis.crypto) == null ? void 0 : _a.randomUUID) == null ? void 0 : _b.call(_a)) != null ? _c : Math.random().toString(36).slice(2)}`;
      }
    ...
    repositionDropdown() {
      ...
      if (!inputEl || !dropdownEl)
        return;
      if (getComputedStyle(dropdownEl).display === "none")
        return;
  ...
  var liveSocket = new LiveSocket2("/live", Socket, {
    ...
    hooks: __spreadValues(__spreadValues({}, Hooks2), live_select_min_default)
    // Register hooks
  });
  var rootComputedStyle = getComputedStyle(document.documentElement);
  var topbarColor = rootComputedStyle.getPropertyValue("--color-primary").trim() || rootComputedStyle.getPropertyValue("--color-brand").trim() || getComputedStyle(document.body).getPropertyValue("color");
  var topbarShadow = rootComputedStyle.getPropertyValue("--color-shadow-strong").trim() || rootComputedStyle.getPropertyValue("--color-overlay").trim();
  import_topbar.default.config({ barColors: { 0: topbarColor }, shadowColor: topbarShadow });
